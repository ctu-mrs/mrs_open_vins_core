...
'
  'OpenVins' 'waitForHw; roslaunch mrs_open_vins_core bluefox.launch
'
  'Republisher' 'waitForHw; roslaunch mrs_vins_republisher vins_republisher_openvins_bluefox.launch
'
